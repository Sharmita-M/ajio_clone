<?php include 'includes/header.php'; ?>
 <div class="flex-grow-1 container-fluid mt-5">
  <h2 class="section-title text-center">📝 Price Management</h2>

  <!-- Add Testimonial Card -->
  <div class="card card-custom">
    <div class="gradient-header">➕ Add Price</div>
    <div class="card-body">
      <form>
         <div class="row">
        <!-- Select Category -->
        ...
        <div class="col-md-4 mb-3">
          ...
          <select id="unitSelect" class="form-select">
            <option selected disabled>Select</option>
            <option value="Shirts">2 Pairs</option>
            <option value="Mobiles">10 Units</option>
            <option value="Shoes">1 Piece</option>
          </select>
        </div>
 <div class="col-md-4 mb-3">
          <label for="price" class="form-label">Add price</label>
          <input type="number" id="price" class="form-control" placeholder="Add Price">
        </div>
      </div>
        
        <button type="submit" class="btn btn-theme w-100">Add Price</button>
      </form>
    </div>
  </div>   
