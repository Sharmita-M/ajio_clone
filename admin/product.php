    ...
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-3">
          ...
          <input type="text" id="sellingPrice" class="form-control" placeholder="Price">
        </div>

        <!-- Market Price -->
        <div class="col-md-4 mb-3">
          <label for="marketPrice" class="form-label">Market Price</label>
          <input type="text" id="marketPrice" class="form-control" placeholder="Market Price">
        </div>
        ...
        <button type="submit" class="btn btn-theme w-100">Add Product</button>
      </form>
    </div>
  </div>   
