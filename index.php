            ...
            <div class="pe-5 ">
                ...
                <div class="collapse navbar-collapse d-flex align-items-baseline mt-2 nav_li" id="navbarNav">
                    <ul class="navbar-nav ms-auto nav dropdown list-unstyled mx-auto">
                        ...
                        <div class="dropdown-menu p-4 shadow border rounded mt-0 " aria-labelledby="dropdownMenuButton">
                            <div
                                ...
                                <nav class="d-flex border border-1 rounded overflow-hidden text-dark small">
                                    <button type="button"
                                        class="btn btn-light fw-semibold border-end" href="product.php">CATEGORIES</button>
                                    <span type="button" class="btn btn-light">BRANDS</span>
                                </nav>
                            </div>
                            <div class="row text-secondary small">
                                <div class="col-6 col-md-3 mb-3">
                                    <ul class="list-unstyled">
                                        <li class="fw-bold text-uppercase small mb-1"> <a href="product.php">Clothing </a></li>
                                        <li class="fw-bold text-uppercase small mb-1">Footwear</li>
                                        <li class="fw-bold text-uppercase small mb-1">Accessories</li>
                                        <li class="fw-bold text-uppercase small mb-1">All Thats New</li>
                                        <li>Clothing</li>
                                        <li>Footwear</li>
                                        <li>Accessories</li>
                                        <li class="fw-bold text-uppercase small mb-1">Ajio Global</li>
                                        <li class="fw-bold text-uppercase small mb-1">Plus Size</li>
                                        <li class="fw-bold text-uppercase small mb-1">Night &amp; Loungewear</li>
                                        <li class="fw-bold text-uppercase d-flex align-items-center gap-1 small mb-1">
                                            Grooming <span class="badge-new">NEW</span>
                                        </li>
                                        <li class="fw-bold text-uppercase d-flex align-items-center gap-1 small mb-1">
                                            Ethnic &amp; Festive <span class="badge-hot">HOT</span>
                                        </li>
                                ...
                                <div class="col-6 col-md-3 mb-3">
                                    <ul class="list-unstyled">
                                        <li class="fw-bold text-uppercase small mb-1">Western Wear</li>
                                        <li>Jackets &amp; Coats</li>
                                        <li>Jeans</li>
                                        <li>Shirts</li>
                                        <li>Shorts &amp; 3/4ths</li>
                                ...
                                <div class="col-6 col-md-3 mb-3">
                                    <ul class="list-unstyled">
                                        ...
                                        <li>Watches</li>
                                        <li class="fw-bold text-uppercase small mb-1">Precious Jewellery</li>
                                        <li>Gold And Silver Coins</li>
                                        <li>Gold And Diamond Jewellery</li>
                                        <li>Silver Jewellery</li>
                                        <li class="fw-bold text-uppercase small mb-1">Innerwear</li>
                                        <li>Briefs</li>
                                        <li>Trunks &amp; Boxers</li>
                                        <li>Vests</li>
                                    </ul>
                                ...
                                <div class="col-6 col-md-3 mb-3">
                                    <ul class="list-unstyled">
                                        <li class="fw-bold text-uppercase small mb-1">Featured</li>
                                        <li>Bags Under 1499</li>
                                        <li>Footwear Under 1499</li>
                                        <li>Jeans Under 1199</li>
                                        <li>Shorts &amp; 3/4ths Under 699</li>
                                        <li class="fw-bold text-uppercase small mb-1">Festive Edits</li>
                                        <li>Diwali Kurta</li>
                                        <li>Dhotis</li>
                    ...
                    <ul class="navbar-nav ms-auto nav dropdown list-unstyled mx-auto justify-content-center">
                        ...
                        <div class="dropdown-menu p-4 shadow border rounded mt-0" aria-labelledby="dropdownMenuButton">
                            <div
                                ...
                                <nav class="d-flex border border-1 rounded overflow-hidden text-dark small">
                                    <span
                                        class="btn-light fw-semibold catagory">CATEGORIES</span>
                                    <span class="btn btn-light brands">BRANDS</span>
                                </nav>
                            </div>
                            <div class="row text-secondary small">
                                <div class="col-6 col-md-3 mb-3">
                                    <ul class="list-unstyled">
                                        <li class="fw-bold text-uppercase small mb-1">Clothing</li>
                                        <li class="fw-bold text-uppercase small mb-1">Footwear</li>
                                        <li class="fw-bold text-uppercase small mb-1">Accessories</li>
                                        <li class="fw-bold text-uppercase small mb-1">All Thats New</li>
                                        <li>Clothing</li>
                    ...
                    <ul class="navbar-nav ms-auto nav dropdown list-unstyled mx-auto">
                        ...
                        <div class="dropdown-menu p-4 shadow border rounded mt-0" aria-labelledby="dropdownMenuButton">
                            <div
                                ...
                                <nav class="d-flex border border-1 rounded overflow-hidden text-dark small">
                                    <button type="button"
                                        class="btn btn-light fw-semibold border-end">CATEGORIES</button>
                                    <button type="button" class="btn btn-light">BRANDS</button>
                                </nav>
                            </div>
                            <div class="row text-secondary small">
                                <div class="col-6 col-md-3 mb-3">
